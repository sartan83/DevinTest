      ...
      <div className="flex flex-col gap-5 sm:gap-7 lg:gap-8">
        ...
        <div className="grid gap-3 sm:grid-cols-2 sm:gap-4 lg:grid-cols-5 lg:gap-4">
          {p.blocks.map((b, i) => (
            <motion.div
              ...
              className="relative flex flex-col overflow-hidden rounded-2xl border border-brand-ivory/20 bg-brand-green-mid/25 p-4 sm:p-5 lg:p-6"
            >
              <div className="flex items-baseline gap-2.5">
                <span className="text-[10.5px] uppercase tracking-[0.26em] text-brand-ivory/78 sm:text-[11px]">
                  Focus
                </span>
              ...
              <p className="mt-2 text-[12.5px] leading-relaxed text-brand-ivory/94 sm:text-[13.5px] lg:text-[14.5px]">
                {b.helper}
              </p>
              {i < p.blocks.length - 1 && (
                <span aria-hidden className="absolute right-3 top-4 hidden text-brand-ivory/42 lg:block">
                  →
                </span>
              )}
            </motion.div>
        ...
        {p.todayGoal ? (
          <motion.div
            ...
            className="relative flex flex-col gap-2 overflow-hidden rounded-2xl border border-brand-ivory/25 bg-brand-ivory/[0.04] px-5 py-4 sm:gap-2.5 sm:px-6 sm:py-5 lg:px-7 lg:py-6"
          >
            <span
              aria-hidden
              className="pointer-events-none absolute inset-y-3 left-0 w-[2px] rounded-full bg-brand-ivory/45"
            />
            <span className="text-[10.5px] uppercase tracking-[0.3em] text-brand-ivory/90 sm:text-[11px]">
              {p.todayGoal.label}
            </span>
        ...
        {p.closing ? (
          <p className="text-[13px] italic leading-relaxed text-brand-ivory/92 sm:text-[14.5px] lg:text-[16px]">
            {p.closing}
          </p>
        ) : null}
      </div>
