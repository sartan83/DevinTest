            ...
            {p.clocks.map((c, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="relative flex min-w-0 flex-col gap-4 overflow-hidden rounded-2xl border border-brand-ivory/18 bg-brand-ivory/[0.04] px-5 py-6 sm:gap-5 sm:px-6 sm:py-7 lg:px-7 lg:py-8"
                >
