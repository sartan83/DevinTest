      ...
      <div className="flex flex-col gap-4 sm:gap-5">
        <div className="grid gap-3 lg:grid-cols-[1.05fr_1fr] lg:items-end lg:gap-8">
          ...
          <div className="flex flex-col gap-2">
            <PanelSubhead className="mt-0">{p.subtitle}</PanelSubhead>
            <p className="text-[12px] leading-relaxed text-brand-ivory/70 sm:text-[13px]">
              {p.intro}
            </p>
          </div>
        </div>
        ...
        <div className="grid gap-2.5 sm:grid-cols-2 sm:gap-3 lg:grid-cols-4">
          {p.kpis.map((k, i) => (
            <motion.div
              ...
              className="relative flex flex-col overflow-hidden rounded-xl border border-brand-ivory/12 bg-brand-green-mid/30 p-3.5 sm:p-4"
            >
              <span className="text-[9px] uppercase tracking-[0.24em] text-brand-ivory/55 sm:text-[10px]">
                {k.title}
              </span>
              <span className="mt-1 font-display text-xl font-light leading-tight text-brand-orange-soft sm:text-2xl">
                {k.metric}
              </span>
              <p className="mt-2 text-[11px] leading-relaxed text-brand-ivory/65 sm:text-[12px]">
                {k.description}
              </p>
        ...
        <div className="grid gap-2.5 sm:gap-3 lg:grid-cols-2">
          <div className="rounded-xl border border-brand-orange/30 bg-brand-orange/5 p-3.5 sm:p-4">
            ...
            <p className="mt-1.5 text-[12px] leading-relaxed text-brand-ivory/85 sm:text-[13px]">
          ...
          <div className="rounded-xl border border-brand-ivory/12 bg-brand-green-mid/20 p-3.5 sm:p-4">
            ...
            <p className="mt-1.5 text-[12px] leading-relaxed text-brand-ivory/75 sm:text-[13px]">
