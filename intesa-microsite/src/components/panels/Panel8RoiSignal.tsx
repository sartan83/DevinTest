 ...
 *   3. Value arc — €70M / €78M / €97M / €116M.
 *   4. ROI logic bar — €70M / 15% → ×83% → 18–30% scenarios.
 *   5. Scenario line — 18% / 20% / 25% / 30% net efficiency → value arc.
 *   6. One caveat.
 *
      ...
      <div className="flex flex-col gap-6 sm:gap-8 lg:gap-9">
        <div className="flex flex-col gap-2 sm:gap-2.5">
          ...
          <motion.p
            ...
            className="max-w-3xl text-[12.5px] leading-snug text-brand-ivory/92 sm:text-[14px] lg:text-[15px]"
          >
            {p.subhead}
          </motion.p>
        </div>
        ...
        <div className="flex flex-col gap-3 sm:gap-3.5">
                ...
                <div key={point.value} className="relative">
                  ...
                  >
                    <div className="flex items-baseline gap-1.5 sm:gap-2">
                      ...
                      {point.unit && (
                        <span className="text-[11px] font-light leading-none text-brand-ivory/82 sm:text-[12.5px] lg:text-[14px]">
                          {point.unit}
                        </span>
                      )}
                    </div>
                    <span className="text-[10.5px] uppercase tracking-[0.28em] text-brand-ivory/92 sm:text-[10.5px] lg:text-[11.5px]">
                      {point.label}
                    </span>
                  ...
                  {i < p.valueArc.points.length - 1 && (
                    <motion.span
                      ...
                      className="pointer-events-none absolute right-[-22px] top-[52%] hidden -translate-y-1/2 select-none text-[26px] font-light leading-none text-brand-ivory/62 sm:right-[-18px] lg:block"
                    >
                      →
                    </motion.span>
                  )}
          ...
          <motion.p
            ...
            className="text-[13px] leading-snug text-brand-ivory/96 sm:text-center sm:text-[14px] lg:text-[15px]"
          >
            {p.valueArc.caption}
          </motion.p>
        </div>
        ...
        <motion.div
          ...
          className="flex flex-col gap-3 border-t border-brand-ivory/20 pt-4 sm:gap-2 sm:pt-5"
        >
          <span className="text-[10.5px] uppercase tracking-[0.32em] text-brand-orange-soft/95 sm:text-[10.5px]">
            ROI logic
          </span>
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-3 sm:gap-2 lg:gap-3">
            {p.logicBar.map((step, i) => (
              ...
              >
                <span className="text-[10.5px] uppercase tracking-[0.28em] text-brand-ivory/70 sm:text-[10.5px]">
                ...
                <div className="flex min-w-0 flex-col gap-0.5">
                  ...
                  <span className="text-[11px] leading-snug text-brand-ivory/90 sm:text-[12px]">
                    {step.result}
                  </span>
                </div>
                {i < p.logicBar.length - 1 && (
                  <span
                    aria-hidden
                    className="pointer-events-none absolute right-[-10px] top-[26%] hidden select-none text-[18px] font-light leading-none text-brand-ivory/42 sm:block"
                  >
                    →
                  </span>
                )}
        ...
        <motion.div
          ...
          className="flex flex-wrap items-baseline gap-x-5 gap-y-1.5 text-[11px] text-brand-ivory/90 sm:text-[12px]"
        >
          {p.scenarioLine.map((s, i) => {
            ...
            return (
              <span key={s.eff} className="flex items-baseline gap-1.5">
                ...
                <span className="text-brand-ivory/70">→</span>
        ...
        <div className="flex flex-col gap-1.5">
          <motion.p
            ...
            className="text-[10.5px] italic leading-snug text-brand-ivory/75 sm:text-[11.5px]"
          >
            {p.caveat}
          </motion.p>
          {p.pilotFooter && (
            <motion.p
              ...
              className="text-[10.5px] leading-snug text-brand-ivory/82 sm:text-[11.5px]"
            >
              {p.pilotFooter}
            </motion.p>
          )}
